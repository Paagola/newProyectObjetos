...
public class PosicionInteligente extends NuevaPosicion {
    ...
    /**
     * En base a un array de booleanos diciendo cuales son las posiciones que puede
     * acceder calcular cual es la mas optima para huir.
     * 
     * @param array
     */
    public void moverSegunArray(boolean[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            if (array[i]) {
                ...
                if (((this.personaje.getClass() == Malo.class) ? totalPasos < pasosminimos
                        : totalPasos > pasosminimos)) {
